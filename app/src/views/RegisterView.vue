<template>
  <div class="auth-view">
    <div class="auth-container">
      ...
      <div class="auth-accent" style="--accent-color: rgba(255, 140, 158, 0.15)"></div>
    </div>
  </div>
</template>
...
.form-input:focus {
  outline: none;
  border-color: rgba(255, 140, 158, 0.6);
  box-shadow: 0 0 0 3px rgba(255, 140, 158, 0.15);
}
